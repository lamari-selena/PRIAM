...
public class DataRequestRestController {
    ...
    // DataRequestServiceImpl.saveRequestAnswer throws this when a DataRequest has
    // already been answered (§7nonies/§13 in the playbook — a known gap, previously
    // surfacing as a generic 500). A 409 with the actual message lets the frontend show
    // something more useful than "Error.." and confirms this is a conflict, not a
    // server fault.
    @ExceptionHandler(IllegalStateException.class)
    public ResponseEntity<String> handleAlreadyAnswered(IllegalStateException ex) {
