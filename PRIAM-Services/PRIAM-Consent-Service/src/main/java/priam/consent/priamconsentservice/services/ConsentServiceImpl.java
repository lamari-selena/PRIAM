...
public class ConsentServiceImpl implements ConsentService{
    ...
    public ConsentResponseDTO create(ConsentRequestDTO consentRequestDTO, String idRef) {
        ...
        // Accept either a numeric processingId or a human-readable
        // processingName, same generic resolution ContractServiceImpl's CDP
        // (getConsentByDataSubject) already does — this endpoint (the
        // actual grant/withdraw toggle) didn't have it, so
        // getDataIds/addProcessedData/removeProcessedData below received
        // the raw name and 400'd (they take the DB's numeric processing_id).
