...
# No auth dependency: reached only by PRIAM's Right service on the internal
# network, per PRIAM-Right-service's ProviderRestClient contract (GET/POST
# /provider/api/dataAccessRight|rectification|erasure, forwarded by the
# Gateway with the /provider prefix stripped).
app.include_router(priam_router, prefix="/api", tags=["PRIAM"])
